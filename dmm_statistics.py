...
if __name__ == '__main__':
    ...
    for i in range(numobjects):
        ...
        ax1.plot(dmm_list[i].E, exact_dmm[i]+i*0.125, '*-', label='Exact')
        ax1.plot(dmm_list[i].E, prop_dmm[i]+i*0.125, '*-', label='Prop')
    ...
    for i in range(numobjects):
        ...
        ax2.plot(dmm_list[i].E, rk4_eigvals[i]+i*.25, '*-', label='RK4')
        ax2.plot(dmm_list[i].E, exact_dmm[i]+i*.25, '*-', label='Exact')
    ...
    for i in range(numobjects):
        ...
        ax3.plot(dmm_list[i].E, zvode_eigvals[i]+i*0.125, '*-', label='Zvode')
        ax3.plot(dmm_list[i].E, exact_dmm[i]+i*0.125, '*-', label='Exact')
