...
if __name__ == "__main__":
	...
	metal_hamiltonian = sparse.diags([diags, diags], [-1, 1], format="coo", dtype='complex')
	...
	for i in range(rows):
		if i % 2 == 0:
			...
			diags.append(0.5)
	insul_hamiltonian = sparse.diags([[0.5], diags, diags, [0.5]], [-99, -1, 1, 99], format='coo', dtype='complex')
